    ...
    <div className="flex min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      <aside className="w-64 border-r border-slate-800 bg-slate-900 flex flex-col justify-between p-4 shrink-0">
        ...
        <div className="border-t border-slate-800/80 pt-4 px-2">
          ...
          <button
            onClick={logout}
            className="flex w-full items-center space-x-3 rounded-xl px-3 py-2 text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-red-400 transition cursor-pointer"
          >
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col overflow-y-auto max-h-screen bg-slate-950">
        <header className="h-16 border-b border-slate-800 flex items-center justify-end px-8 bg-slate-900/40">
          <div className="text-xs text-slate-500 font-medium bg-slate-900 border border-slate-800 px-3 py-1 rounded-full">
            Active Connection: Secure Session
          </div>
        </header>
