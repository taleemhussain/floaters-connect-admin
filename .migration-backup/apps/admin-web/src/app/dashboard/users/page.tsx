      ...
      <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 bg-slate-900 border border-slate-800 p-4 rounded-xl">
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="bg-slate-950 border border-slate-800 rounded-lg text-sm text-slate-300 py-2 px-3 focus:outline-none focus:border-red-500"
          >
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-800 text-sm text-slate-300">
                {filteredUsers.map((user) => (
                  <tr key={user.uid} className="hover:bg-slate-850/10">
                    ...
                    <td className="px-6 py-4 text-right space-x-2">
                      {user.onboardingStatus !== 'registered' && (
                        <button
                          ...
                          className="inline-flex items-center justify-center p-1.5 rounded-lg border border-slate-700 bg-slate-800 hover:bg-green-600 hover:text-white text-slate-300 transition"
