...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        function AppController_1(firebaseConfigured) {
            this.firebaseConfigured = (__runInitializers(this, _instanceExtraInitializers), firebaseConfigured);
        }
        AppController_1.prototype.getIndex = function () {
            return {
    ...
    (function () {
        ...
        _getIndex_decorators = [(0, common_1.Get)()];
        _getHealth_decorators = [(0, common_1.Get)('healthz')];
