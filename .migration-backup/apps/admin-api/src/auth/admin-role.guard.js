...
var AdminRoleGuard = function () {
    ...
    var AdminRoleGuard = _classThis = /** @class */ (function () {
        function AdminRoleGuard_1(firestore) {
            this.firestore = firestore;
            this.logger = new common_1.Logger(AdminRoleGuard.name);
        }
        AdminRoleGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, user, userRef, userSnap, userData, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            userRef = this.firestore.collection(firebase_1.FirestoreCollections.users).doc(user.uid);
                            return [4 /*yield*/, userRef.get()];
                        case 2:
                            userSnap = _a.sent();
                            if (!userSnap.exists) {
                                this.logger.warn("Admin role check failed: user record ".concat(user.uid, " not found in Firestore"));
                                throw new common_1.ForbiddenException({
                                    code: 'USER_NOT_FOUND',
                            ...
                            if ((userData === null || userData === void 0 ? void 0 : userData.role) !== 'admin') {
                                this.logger.warn("Admin role check failed: user ".concat(user.uid, " role is ").concat((userData === null || userData === void 0 ? void 0 : userData.role) || 'unset'));
                                throw new common_1.ForbiddenException({
                                    code: 'ADMIN_REQUIRED',
                        ...
                        case 3:
                            ...
                            this.logger.error("Error verifying admin role for user ".concat(user.uid, ": ").concat(error_1.message));
                            throw new common_1.ForbiddenException({
                                code: 'ACCESS_DENIED',
