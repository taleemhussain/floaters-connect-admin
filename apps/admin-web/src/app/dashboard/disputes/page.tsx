          ...
          {loading ? (
            ...
            disputes.map((dispute) => (
              <div
                ...
                className={`bg-slate-900 border p-6 rounded-2xl shadow-md transition flex flex-col justify-between cursor-pointer ${
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6 sticky top-8 shadow-xl">
              ...
              <form onSubmit={handleResolve} className="space-y-4">
                ...
                <div className="flex space-x-2">
                  <button
                    type="submit"
                    className="flex-1 rounded-lg bg-green-600 hover:bg-green-500 text-white text-sm font-semibold py-2 transition"
                  >
                    Confirm Resolution
                  </button>
                  <button
